...
public class MainNewsItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (readSeq.contains(entities.get(position).getId() + "")) {
            ...
            viewHolder.tv_title.setTextColor(context.getResources().getColor(isLight ?
                    android.R.color.black : android.R.color.white));
        }
        ((LinearLayout) viewHolder.iv_title.getParent().getParent().getParent()).setBackgroundColor(context.getResources()
                .getColor(isLight ? R.color.light_news_item : R.color.dark_news_item));
        viewHolder.tv_topic.setTextColor(context.getResources()
        ...
        if (entity.getType() == Constant.TOPIC) {
            ...
            ((FrameLayout) viewHolder.tv_topic.getParent()).setBackgroundResource(isLight ?
