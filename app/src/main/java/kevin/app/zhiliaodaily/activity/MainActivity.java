...
import kevin.app.zhiliaodaily.db.CacheDbHelper;
import kevin.app.zhiliaodaily.fragment.MainFragment;
import kevin.app.zhiliaodaily.fragment.MenuFragment;
import kevin.app.zhiliaodaily.fragment.NewsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void setSwipeRefeshEnable(boolean enable) {
    ...
    public void onBackPressed() {
        if (mDrawerLayout.isDrawerOpen(Gravity.LEFT)){
            ...
            if (secondTime-firstTime>2000){
                ...
                sb.getView().setBackgroundColor(getResources().getColor(isLight?android.R.color.holo_blue_dark:
