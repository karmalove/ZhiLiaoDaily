package kevin.app.zhiliaodaily.model;
...
public class Latest {
     ...
     * date : 20150813
     */
    private List<TopStoriesEnity> top_stories;
    ...
    public void setTop_stories(List<TopStoriesEnity> top_stories) {
    ...
    public List<TopStoriesEnity> getTop_stories() {
        return top_stories;
    }
    ...
    public static class TopStoriesEnity {
        /**
         * id : 7048089
    ...
    @Override
    public String toString() {
        return "Latest{" + "top_stories=" + top_stories +
                ",stories=" + stories +
                ",date='" + date + '\'' +
                '}';
    }
